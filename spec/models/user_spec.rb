...
RSpec.describe User, type: :model do
  ...
  it { should have_valid(:role).when(find_role_id('Customer'), find_role_id('Restaurant'), find_role_id('Driver')) }
  it { should_not have_valid(:role).when(nil, '', 'asdf', 'user@example.com') }
